...
$(document).ready(function() {
		let textSwal = "Welcome to <br />Introduction to College Writing<br><br><button class='button' onClick='swal(\"Hello world!\");' id='syllabusLink'>Click to Read the Syllabus</button>"
		let idPick = "#0";
		for (i = 1; i < 118; i++) { 
				...
				switch (i) { 
					case 57:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "<br>Mid-term</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><button class='button' onClick='swal(\"Hello world!\");' id='syllabusLink'>Click to Read the Syllabus</button>");
					...
					case 60:
					case 61:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "<br>Spring Break No Classes</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><button class='button' onClick='swal(\"Hello world!\");' id='syllabusLink'>Click to Read the Syllabus</button>");
					$(".day:contains(" + i + ")").css( "background-color", "#66ff33" );
					break;
					case 113:
					case 114:
					...
					case 116:
					case 117:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "<br>Final Exam Week</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><button class='button' onClick='swal(\"Hello world!\");' id='syllabusLink'>Click to Read the Syllabus</button>");
					$(".day:contains(" + i + ")").css( "background-color", "#66ff33" );
					break;
					default:
					$("#content").append("<div class='day' id='day" + i + "'>" + i + " <br><strong>" + newDateFormat + "</strong></div><div data='" + newDateFormat  + "' id='info" + i + "' class='inform'>Welcome to <br />Introduction to College Writing<br><br><button class='button' onClick='swal(\"Hello world!\");' id='syllabusLink'>Click to Read the Syllabus</button>");
					};
