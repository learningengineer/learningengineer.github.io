...
var questions = [
	...
	{ img: 'play.png', color:'#808000', word: 'acumen', sound: 'sounds/acumen' }, //no audio
...
$( function() {
    ...
    function buildGame( x ) {
        ...
        var letterWidth = $models.find( 'li' ).outerWidth( true ); //+ 10;
        ...
        $letters.find( 'li' ).each( function( i ) {
				var top   = ( $models.position().top ) + 280,
					left  = ( $models.offset().left - $container.offset().left - 140) + (i * letterWidth +5),
					angle = 0;		
    ...
    function winGame() {
		...
		if ( NumOfQues < 1) {
			...
			document.getElementById( "score" ).innerHTML = "Score = " + scoreKK + " | Percent Correct = " + PercentTotal.toFixed(2) + "% | Remaining questions = " + NumOfQues; 
			document.getElementById("sent").style.textAlign = "center";
			document.getElementById( "sent" ).innerHTML = '<font style="color:#00FF00; font-size:1em;"></br>Correct +10</font>'; 
